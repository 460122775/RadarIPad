...
- (void)setTimeBroadcastView
{
    ...
    [nowPickerShowTimeLabel setTextColor:BackGroundBlueColor];
...
//    [self addSubview:nowPickerShowTimeLabel];
    ...
    timeBroadcastView.layer.borderColor = [BackGroundGrayColor CGColor];
